...
xtestman /= 255
#Prepare y
ytrainman = keras.utils.to_categorical(ytrain, 6)
ytestman = keras.utils.to_categorical(ytest, 6)
yvalman = keras.utils.to_categorical(yvalidation, 6)
...
plot_confusion_matrix(matrix, ["Building","Forest", "Street"], normalize=True)
