...
xtest /= 255
#Prepare y
ytrainnat = keras.utils.to_categorical(ytrain, 6)
ytestnat = keras.utils.to_categorical(ytest, 6)
yvalnat = keras.utils.to_categorical(yvalidation, 6)
